...
# 
def exec_provision_request(image, vm_name)
  ...
  post_params = {
    ...
    :vm_fields => {
      ...
      :instance_type    => ["163", "t2.micro: T2 Micro"],
      :monitoring       => ["basic", "Basic"],
      # :name           => "AWS VM - Red Hat Enterprise Linux 7.4",
...
$evm.log(:info, "VM Name: #{vm_name}")
exec_provision_request(image, vm_name)
